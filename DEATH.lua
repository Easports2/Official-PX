...
local Window = Rayfield:CreateWindow({
	...
	KeySettings = {
		...
		Key = loadstring(game:HttpGet('https://raw.githubusercontent.com/Easports2/Official-PX/refs/heads/main/Keysystem.lua'))() -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
	}
})
